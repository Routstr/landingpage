...
> **Note**: OpenCode v0.3.0 includes a patch for seamless integration, running on api.nonkycai.com (community) and staging.routstr.com (team). This example uses nonkycai for its competitive pricing.
