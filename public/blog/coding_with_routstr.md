...
I've been using Roo Code and Goose via Routstr for a while now. The best way to keep track of all your Cashu tokens and API keys has been through Routstr Platform. Here's how:
1.  Log in to Routstr Platform using your Nostr extension or create a new nsec just for this.
...
If you just want a way to top up your current Cashu token to avoid creating one every now and then, you can use Routstr Platform wallet.
<TOPUP IMAGE>
