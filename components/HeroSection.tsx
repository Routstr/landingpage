    ...
    <section className={`bg-black py-12 sm:py-16 md:py-20 relative overflow-hidden w-full ${className}`}>
      <div className="px-4 md:px-6 relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-block mb-3 px-3 py-1 bg-white/10 text-white rounded-full text-xs sm:text-sm font-mono">
          ...
          <p className="mb-6 sm:mb-8 text-lg sm:text-xl text-gray-300">{description}</p>
          ...
          {footerText && <p className="text-xs sm:text-sm text-gray-400 font-mono overflow-hidden text-ellipsis">{footerText}</p>}
        </div>
      </div>
    </section>
  );
