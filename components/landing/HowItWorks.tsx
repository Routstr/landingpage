      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-center mb-16">
          <div className="bg-neutral-900 rounded-full p-1 flex gap-1 border border-white/10">
            <button
              className={cn(
                "px-6 py-2.5 rounded-full text-sm font-medium transition-colors duration-300",
                activeTab === "users"
  ...
  const steps = [
    {
      ...
      description:
        "Bring your own Cashu eCash token. No account or sign-up required.",
    ...
    },
    {
      ...
      description:
        "Point your existing OpenAI SDK or application at any Routstr provider. Use your Cashu token as the API key.",
      visual: <ApiKeyVisual />,
    },
    {
      number: 3,
      ...
      description:
        "Cost is deducted based on actual token usage. Model-based pricing with live BTC/USD conversion.",
  ...
  const steps = [
    {
      ...
      description:
        "Run Routstr Core in front of any OpenAI-compatible API. One Docker command to monetize your AI infrastructure.",
      visual: <DockerVisual />,
    },
    {
      number: 2,
      ...
      description:
        "Connect to a Cashu mint for eCash payments. No Stripe, no KYC, no payment processing fees.",
    ...
    },
    {
      ...
      description:
        "Publish your node to Nostr relays. Users can discover your services through decentralized provider listings.",
        ...
        <div className="bg-neutral-800/50 rounded-lg border border-white/10 p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <motion.div
                animate={
                  isInView ? { opacity: [0.5, 1, 0.5] } : { opacity: 0.75 }
                }
      ...
      <div className="w-full max-w-xs">
        <div className="bg-neutral-800/50 rounded-lg border border-white/10 p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-1.5">
            {["OpenAI SDK", "LangChain", "LlamaIndex", "AI SDK"].map(
              (label) => (
                <span
                  key={label}
                  className="px-2 py-0.5 text-[10px] bg-neutral-700/50 rounded text-neutral-400"
                >
                  {label}
                </span>
              )
...
const DockerVisual = () => {
  ...
  return (
    <div
      ref={ref}
      className="w-full h-full p-4 font-mono text-[10px] leading-tight overflow-hidden"
    >
      <div className="text-neutral-400 mb-1">
        $ docker run -p 8080:8080 routstr/proxy
      </div>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
