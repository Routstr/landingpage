      ...
      <div className="text-center mb-16">
        ...
        >
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4 tracking-tight">
            ...
            <span className="text-white">AI Economy</span>
          </h2>
      ...
      <div className="grid grid-flow-col grid-cols-1 grid-rows-6 gap-4 md:grid-cols-2 md:grid-rows-3 xl:grid-cols-3 xl:grid-rows-2">
        <Card className="row-span-2">
          <CardContent>
            ...
            <CardDescription>
              Works with any OpenAI SDK, LangChain, or application. Drop-in
        ...
        <Card className="overflow-hidden">
          <CardContent>
            ...
            <CardDescription>
              No subscriptions. Pay only for the tokens you use with Bitcoin
              micropayments.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="row-span-2">
          <CardContent>
            ...
            <CardDescription>
              Run the Routstr proxy in a single Docker container to monetize
              your hardware.
            </CardDescription>
          </CardContent>
...
const ApiRequestSkeleton = () => {
  ...
  return (
    <div
      ref={ref}
      className="p-4 w-full h-full flex flex-col gap-2 bg-gradient-to-b from-neutral-900/50 to-neutral-950 font-mono text-[10px]"
    >
      {/* Terminal header */}
      ...
      {/* Code block */}
      <div className="space-y-0.5 text-[9px] leading-relaxed text-neutral-400">
        <div>
        ...
        <div className="pl-3">
          api_key=<span className="text-green-400">&quot;cashuA...&quot;</span>
        </div>
        <div>)</div>
      </div>
        ...
        >
          <div className="bg-neutral-800/80 border border-neutral-700/50 rounded-lg px-2 py-1.5 text-neutral-300 max-w-[85%]">
            {step >= 3 ? (
              ...
              <motion.span
                animate={
                  isInView ? { opacity: [0.4, 1, 0.4] } : { opacity: 0.4 }
                }
...
const PaymentSkeleton = () => {
  ...
  return (
    <div
      ref={ref}
      className="w-full h-full relative overflow-hidden flex items-center justify-center bg-neutral-900/20"
    >
...
const DockerSkeleton = () => {
  ...
  return (
    <div
      ref={ref}
      className="w-full h-full bg-neutral-950 p-4 font-mono text-[9px] overflow-hidden"
    >
      {/* Terminal header */}
      ...
      <div className="text-neutral-400 mb-3">
        <span className="text-neutral-500">$</span> docker run -p 8080:8080
        routstr/proxy
      </div>
...
const CardSkeletonBody = ({
  ...
  return (
    <div className={cn("flex-1 min-h-[150px]", className)}>{children}</div>
  );
};
